...
/**
 * MultiStreamTest implementation of KiteTest.
 *
 ...
 * </ul>
 */
public class MultiStreamTest extends KiteTest {

  private static final Logger logger = Logger.getLogger(MultiStreamTest.class.getName());
  ...
  private class Tester implements Callable<JsonObject> {
    ...
    public JsonObject call() throws Exception {
      ...
      if (!everythingOK) {
        ...
        everythingOK =
            checkVideoDisplay(this.webDriver, 0, TIMEOUT, INTERVAL)
                && checkVideoDisplay(this.webDriver, 1, TIMEOUT, INTERVAL);
      }
      ...
      if (!everythingOK) {
        ...
        everythingOK =
            checkVideoDisplay(this.webDriver, 2, TIMEOUT, INTERVAL)
                && checkVideoDisplay(this.webDriver, 3, TIMEOUT, INTERVAL);
      }
