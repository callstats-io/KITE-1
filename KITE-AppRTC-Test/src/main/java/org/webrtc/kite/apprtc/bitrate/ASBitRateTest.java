...
/**
 * ASBitRateTest implementation of KiteTest.
 * <p>
 ...
 * stashed earlier.</li>
 * </ul>
 * <li>4) The test is considered as successful if the bitrate of the sent audio is equal to the one in the option</li>
 * <li>5) A successful test returns a boolean 'true' while the unsuccessful test returns a boolean
 * 'false'.</li>
 * </ul>
 * </p>
 */
public class ASBitRateTest extends KiteTest {

  private final static Logger logger = Logger.getLogger(ASBitRateTest.class.getName());
  ...
  private class Tester implements Callable<JsonObject> {
    ...
    public JsonObject call() throws Exception {
      ...
      if (everythingOK){
        double bitrate = Utility.getBitrate(webDriver, "audio", true);
