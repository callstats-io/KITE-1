 ...
 * <li>c) Executes the JavaScript on the given via GetResolutionScript() which store result and stats
    ...
    public JsonObject call() throws Exception {
      ...
      if (everythingOK){
        ...
        if (resolution.getInt("width") == -1 || resolution.getInt("height") == -1){
          ...
          everythingOK = ((resolution.getInt("width") == 1280) && (resolution.getInt("height") == 720));
          if (!everythingOK) {
