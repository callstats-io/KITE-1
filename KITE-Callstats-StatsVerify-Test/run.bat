@echo off
IF "%1"=="cosmogrid" (
  java -cp ../KITE-Engine/target/kite-jar-with-dependencies.jar;target/callstats-test-1.0-SNAPSHOT.jar org.webrtc.kite.Engine configs/cosmogrid.edge-safari.config.json
) ELSE IF "%1"=="win" (
